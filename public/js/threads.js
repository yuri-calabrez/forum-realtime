...
/* harmony default export */ __webpack_exports__["default"] = ({
    props: ['title', 'thread', 'replies', 'open', 'newThread', 'threadBody', 'threadTitle', 'send'],
    data: function data() {
        return {
            threads_response: [],
            threads_to_save: {
    ...
    methods: {
        ...
        getThreads: function getThreads() {
            ...
            axios.get('/threads').then(function (response) {
                _this3.threads_response = response.data;
            });
        }
    }
});
...
var render = function() {
  ...
  return _c("div", { staticClass: "card" }, [
    ...
    _vm._v(" "),
    _c("div", { staticClass: "card-content" }, [
      _c("div", { staticClass: "card-title" }, [_vm._v(_vm._s(_vm.newThread))]),
      _vm._v(" "),
      _c(
        "form",
        {
